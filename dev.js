 ...
 *
 * Date: 2015-03-20 00:03
 */
/*
Change Log:
     Added release for nodejs.
*/
...
var PQUEUE = function () {
    ...
    var PQ = {
         ...
         */
        'status': 0,
        // name of the process where error occured.
        'errorProcess': '',
    ...
    // >>> pc related functions
    function fireError(message, processName) {
        queueError(true);
        PQ.errorProcess = processName;
    ...
    function tick() {
        ...
        if (queueError()) {
            warn('Has error(s) in ' + PQ.name + '/' + PQ.errorProcess);
            // is not ticking
        ...
        try {
            ...
            fireError(e.message, theProcess.name);
        }
        // clear running flag
...
// Add methods to toggle logs
Object.defineProperty(PQUEUE, "EnableLog", {
    configurable: false,
    enumerable: false,
    value: function () {
        logEnabled = true;
...
Object.defineProperty(PQUEUE, "DisableLog", {
    configurable: false,
    enumerable: false,
    value: function () {
        logEnabled = false;
